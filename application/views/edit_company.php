        ...
        <div class="col-md-4 col-xs-6 col-md-offset-4 col-xs-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo form_open('admin/edit_company/' . $company['id']); ?>
                    ...
                    <div class="form-group <?php echo $errorName ? 'has-error' : '' ?>">
                        <div class="input-group">
                            ...
                            <?= form_input('name', $company['name'], 'class="form-control" placeholder="Имя компании"')?>
                        </div>
                        <?= $errorName; ?>
                    </div>
                    ...
                    <div class="form-group <?php echo $errorFname ? 'has-error' : '' ?>">
                        <div class="input-group">
                            ...
                            <?= form_input('fullname', $company['fullname'], 'class="form-control" placeholder="Полное имя"')?>
                        </div>
                        <?= $errorFname; ?>
                    </div>
                    ...
                    <div class="form-group <?php echo $errorSname ? 'has-error' : '' ?>">
                        <div class="input-group">
                            ...
                            <?= form_input('shortname', $company['shortname'], 'class="form-control" placeholder="Короткое имя"')?>
                        </div>
                        <?= $errorSname; ?>
                    </div>
                    <?= form_submit('submit', 'Отредактировать компанию', 'class="btn btn-primary"')?>
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div>
